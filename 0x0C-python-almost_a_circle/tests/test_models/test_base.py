...
Unittest classes:
    Test_Base_class
    Test_Task15_Dictionary_to_JSON_string
"""
...
class Test_Task15_Dictionary_to_JSON_string(unittest.TestCase):
    """unittest for Task 15"""
...
class Test_Task16_JSON_string_to_file(unittest.TestCase):
    """unittest for Task 16"""
...
class Test_Task17_JSON_string_to_dictionary(unittest.TestCase):
    """unittests for task 17"""
